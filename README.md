> **This project now uses a serverless architecture!**
>
> See the updated [README.serverless.md](README.serverless.md) for details on how to use AWS Lambda, API Gateway, and DynamoDB with CDK.
